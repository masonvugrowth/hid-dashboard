...
class DailyMetrics(Base):
    ...
    room_revenue_native = Column(Numeric(15, 2), nullable=True)
    dorm_revenue_native = Column(Numeric(15, 2), nullable=True)
    adr_native = Column(Numeric(12, 2), default=0)
    room_adr_native = Column(Numeric(12, 2), nullable=True)
    dorm_adr_native = Column(Numeric(12, 2), nullable=True)
